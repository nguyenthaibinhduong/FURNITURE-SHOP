                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form method="POST" action="" class="user">
                                ...
                                <div class="form-group ">
                                    <input name="password" name="" type="password" class="form-control form-control-user"
                                ...
                                <button name="register" type="submit" href="login.html" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </button>
                            </form>
                            <hr>
